...
import SideViewToolBar from "./SideViewToolBar";
import {
  getCoreRowModel,
  useReactTable,
  getSortedRowModel,
...
interface DataTableProps<TData extends { id: string | number }> {
  ...
  onClickNewBtn?: () => void;
  topTitle?: string;
  addNewRowForm?: React.ReactNode;
  showAddNewRowForm?: boolean;
  toolBarVariant?: "side" | "main";
    ...
    <div className="">
      {toolBarVariant === "main" ? (
        <DataTableToolbar
          ...
          topIconsComponent={topIconsComponent}
        />) :
        <SideViewToolBar
          table={table}
      ...
      >
        <div className=" mt-2 rounded-zeak overflow-x-auto">
          {listViews?.find((view) => view.name === selectedView)?.component ||
            <motion.table
              initial={{ opacity: 0, }}
              ...
              <motion.tbody
                ...
                >
                  {showAddNewRowForm && addNewRowForm}
