...
export function Tabs({
    ...
    rightContent,
    ...props
}: TabsProps & { children?: React.ReactNode, rightContent?: React.ReactNode }) {
    ...
    const renderTabs = () => {
        ...
        if (variant === 'underline') {
            ...
            return (
                <div className={cn("w-full flex justify-between", underlineTabClassName, backgroundColor ? `bg-[${backgroundColor}]` : 'bg-white')}>
    ...
    return (
        <TabsPrimitive.Root
            ...
            {...props}
        >
            <TabsPrimitive.List className="w-full flex justify-between">
                {renderTabs()}
