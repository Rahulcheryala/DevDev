...
export function Tabs({
    ...
    const renderTabs = () => {
        ...
        if (variant === 'underline') {
            ...
            return (
                <div className={cn("w-full px-6 rounded-b-zeak", backgroundColor ? `bg-[${backgroundColor}]` : 'bg-white')}>
                    <div className="flex items-center gap-6">
                        {visibleItems.map((item) => (
                            <TabsPrimitive.Trigger
                                ...
                                className={cn(
                                    "flex flex-col relative px-2 items-center outline-none",
                                    "data-[state=active]:border-0 group",
                                    item.disabled && "opacity-50 cursor-not-allowed pointer-events-none"
                                )}
                            >
                                <div className="px-[14px] h-[60px] group-data-[state=active]:font-semibold group-hover:text-[#0D0C22] flex items-center pt-[10px] pb-1 leading-[20px]">
                                    {item.label}
                                </div>
