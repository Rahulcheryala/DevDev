...
import { Popover, PopoverContent, PopoverTrigger } from "../../micro-components/Popover"
...
export default function Calendar({ value, onChange, defaultValue }: DatePickerProps) {
        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    ...
                    <CalendarIcon className="mr-2 h-5 w-5 text-[#9BA2AC]" />
                </button>
            </PopoverTrigger>
