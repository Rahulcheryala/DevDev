    ...
    >
      ...
      >
        <thead className="text-left">
          <tr
            className={cn(
              'bg-[#F0F4FD] !table-row w-full', // to negate the default table-row classes from data-table.css
          ...
          <tbody className="text-left bg-[#F8FAFE]">
            {rows.map((row, rowIndex) => (
              <tr
                key={rowIndex}
                className={cn(
                  '!table-row w-full', // to negate the default table-row classes from data-table.css
