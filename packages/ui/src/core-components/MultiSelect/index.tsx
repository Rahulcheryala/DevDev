...
const MultiSelect = ({
    ...
    useEffect(() => {
        if (selectedOptions !== defaultValue) {
    ...
    return (
        <div ref={containerRef} className={cn("flex flex-col w-full relative", className)}>
            <label className="h-7 block text-[#475467] font-['Suisse_Int\\'l'] text-sm font-medium leading-5 tracking-[0.2px] mb-1.5">
                {label}
            </label>
            ...
            {isOpen && (
                <div className="absolute z-10 top-full w-full mt-1 bg-white rounded-xl shadow-[0px_0px_15px_0px_rgba(223,229,242,0.80)]">
