...
type ToastVariant = "normal" | "small";
...
const createToast =
  (type: ToastType) =>
    (title: string, description: string, options?: CustomToastOptions) => {
      ...
      const widthClass = variant === "small" ? "min-w-[500px]" : "min-w-[746px]";

      return sonnerToast.custom(
        (id) => (
          <div className={`flex ${widthClass} items-center gap-4`}>
            <div
              className={cn(
                    ...
                    {visibleActions.map((action, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "w-40 h-14 min-w-[160px] max-w-[600px] truncate px-6 py-4 rounded-md text-sm font-medium transition-colors",
                            index === 0
                              ? styles.primaryBtnBg
                              : styles.secondaryBtnBg
                          )}
