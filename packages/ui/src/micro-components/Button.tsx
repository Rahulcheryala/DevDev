...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Base style classes
    const baseClasses =
      "inline-flex items-center justify-center font-medium rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary focus-visible:ring-opacity-50 disabled:pointer-events-none";
    ...
    return (
      ...
      >
        {isLoading ? (
          <>
            {spinner ? (
              <span className={cn(spinnerClassName)}>{spinner}</span>
            ) : (
              defaultSpinner
            )}
