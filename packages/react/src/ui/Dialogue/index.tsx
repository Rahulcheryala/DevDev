...
export function Dialogue({
    ...
    return (
        <div className="flex flex-col">
            <div className={cn("min-w-[1174px]", className)}>
                {/* Accordion Header */}
                <button
                    onClick={() => setIsOpen(!isOpen)}
                    className="w-full h-[56px] flex items-center justify-between px-6 bg-[#E5EAF2] rounded-t-xl"
                >
                    <span className="font-['Suisse_Int\\'l'] text-[20px] font-medium leading-7 tracking-[0.2px] text-[#0D0C22] text-left text-underline-position-from-font text-decoration-skip-ink-none">
                        Attachments
                    </span>
                    <ChevronDownIconBold
                        className={cn(
