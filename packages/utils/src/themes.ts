...
export const themes = [
  {
    ...
    cssVars: {
      light: {
        background: "203, 40%, 96%, 1",
        foreground: "26, 39%, 7%",
        warning: "34, 100%, 53%, 1",
        "warning-foreground": "36, 99%, 47%, 0.1",
        card: "0 0% 100%",
        "card-foreground": "220 10% 3.9%",
        popover: "0 0% 100%",
        "popover-foreground": "220 10% 3.9%",
        primary: "237, 32%, 12%, 1",
        "primary-foreground": "0, 0%, 0%, 0.06",
        secondary: "224, 7%, 40%, 1",
        "secondary-foreground": "224, 7%, 40%, 1",
        tertiary: "235, 2%, 55%",
        muted: "0 0% 95.69%",
        "muted-foreground": "220 3.8% 46.1%",
        accent: "26, 39%, 7%",
        "accent-foreground": "26, 39%, 7%, 0.1",
        "accent-green": "162, 95%, 34%",
        "accent-blue": "208, 88%, 44%, 1",
        "accent-blue-light": "180, 82%, 42%, 0.2",
        destructive: "0 84.2% 60.2%",
        "destructive-foreground": "0 0% 98%",
        "dropdown-hover-bg": "202, 41%, 88%",
        "checkbox-border": "240, 4%, 75%",
        stroke: "241, 13%, 92%, 1",
        border: "220 5.9% 90%",
        input: "220 5.9% 90%",
        ring: "220 5.9% 10%",
        "primary-blue": "208, 88%, 44%, 1",
      },
      dark: {
  ...
  },
  {
    ...
    cssVars: {
      light: {
        ...
        destructive: "0 84.2% 60.2%",
        "destructive-foreground": "0 0% 98%",
        "accent-gray-deep": "0, 0%, 85%, 1",
        "accent-orange-deep": "21, 91%, 54%, 1",
        border: "0 0% 89.8%",
        input: "0 0% 89.8%",
        ring: "0 0% 3.9%",
      },
