...
import { BadgeComponent, Button, Label } from '@zeak/react'
                ...
                <div className="flex items-center justify-between w-full py-[8px] px-[24px] rounded-[12px] rounded-b-none bg-[#E5EAF2]">
                    <div className="flex items-center gap-4">
                        ...
                        {isActive && (
                            ...
                            //     </span>
                            // </span>
                            <BadgeComponent showIcon={true} items={[{ label: "ACTIVE", value: "ACTIVE", selected: false }]} className='bg-white text-[#28CD41] text-[14px] leading-[18px] tracking-[0.2px] font-medium' />
                        )}
                    </div>
