        ...
        <section className="w-full ">
          <h2 className="text-sm font-medium mb-3">Users</h2>
            ...
            {filterItems(users).map((user: Item) => (
                <MultiSelectItem key={user.id} name={user.name} />
            ))}
            <div className="pt-1">
        ...
        <section className="w-full " >
          ...
          <div className=" flex flex-wrap items-center gap-3 ">
            {filterItems(teams).map((team: Item) => (
              <MultiSelectItem key={team.id} name={team.name} />
            ))}
            <div className="pt-1">
              <a href="#" className="text-sm text-blue-600 hover:underline">See All</a>
            </div>
        ...
        <section className="w-full  ">
          ...
          <div className=" flex flex-wrap items-center gap-3">
            {filterItems(departments).map((department: Item) => (
              <MultiSelectItem key={department.id} name={department.name} />
            ))}
            <div className="pt-1">
              <a href="#" className="text-sm text-blue-600 hover:underline">See All</a>
            </div>
...
export  function MultiSelectItem({name, image}: {name: string, image?: string}) {
    return (
