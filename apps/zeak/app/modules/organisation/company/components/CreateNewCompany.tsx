...
export default function CreateCompany() {
  return (
    <div className="w-full h-full bg-white flex-1 flex-grow rounded-[12px] ">
      ...
      <Link to="/x/access-settings/companies/new" className="block h-full">
        <div className="flex flex-col p-8 h-full gap-4 bg-[rgba(102,212,206,0.30)] overflow-y-hidden">
          <h1 className="text-[#101828] text-[36px] font-[450] tracking-[0px]">Create your first company</h1>
          <TbPlus className="w-8 h-8" color="#fff" />
        </div>
      </Link>
    </div>
  )
