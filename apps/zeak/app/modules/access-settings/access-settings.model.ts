...
export const teamUpdatevalidtor = z.object({
  id: zfd.text(z.string().min(2, { message: "Team Id required" })),
...
export const teamValidator = z.object({
  id: zfd.text(z.string().optional()),
  name: z.string().min(2, { message: "Name is required" }),
  teamCode: z.string().min(2, { message: "teamCode is required" }),
  description: z.string().min(2, { message: "Description is required" }),
  parentTeam: z.string().optional(),
  privacy: z.string().optional(),
  teamLeader: z.string().optional(),
  ...
  image: z.union([z.any(), z.string()]).optional(),
});
