...
const Delay: React.FC<Props> = ({
  ...
  const mockConditions: any[] = [
    { value: "continue if Yes or no", label: "continue if Yes or no" },
    { value: "or only yes", label: "or only yes" },
    { value: "or only no", label: "or only no" },
  ];
        ...
        {selectedItem ? (
          ...
          <div className="p-4">
            <div className="mb-4">
              ...
              onChange={(e: { target: { value: React.SetStateAction<string>; }; }) => setSelectedCondition(e.target.value)}
              className="w-full"
            >
              <option value="">Select a condition</option>
              <option value="yesOrNo">Continue if Yes or No</option>
              <option value="onlyYes">Only Yes</option>
            </Select> */}
