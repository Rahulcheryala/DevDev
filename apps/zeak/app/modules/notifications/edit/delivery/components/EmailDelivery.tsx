...
const EmailDelivery = ({
  ...
  return (
    <div className="grid grid-cols-2 gap-y-10 gap-x-[60px]">
      ...
      <div>
        <ClearableInput
          id="emailConfigSubject"
          name="emailConfigSubject"
          ...
          value={notificationDetails.emailConfigSubject}
        />
      </div>
      <div className="col-span-2">
        <div className="has-variable-dropdown">
          <QuillEditor
            value={notificationDetails.emailContent}
            onChange={(value) =>
              onSelectChange({ name: "emailContent", value: value })
            }
          />
