...
import { useConnectionContext } from "~/modules/integrations/context/connection";
  ...
  export const integrationGeneralInfoSchema = z.object({
   ...
   export const General = () => {
    ...
    const { integrationSettings } = connectionForm;
    const fileInputRef = useRef<HTMLInputElement>(null);
    const [showComparisonTable, setShowComparisonTable] = useState(false);
    const [connectionStatus, setConnectionStatus] = useState<string>(
        integrationSettings.connectionMode || "online"
      );
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[60px] md:gap-8">
              <div className="flex flex-col gap-3 relative">
                <Label htmlFor="integrationType" className="text-textLink">
                  Integration Type <span className="text-lg text-accent-red">*</span>
                </Label>
                <Select
                  name="integrationType"
                  value={connectionForm.integrationType}
                  onValueChange={(value) =>
                    handleChange({
              ...
              <div className="flex flex-col gap-3 relative">
                ...
                <Select
                  ...
                  value={connectionForm.integrationName}
                  onValueChange={(value) =>
                    handleChange({
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-[60px] md:gap-8">
              ...
              <div className="flex flex-col gap-3 relative">
                ...
                <Input
                  ...
                  className="bg-inputBg border-0"
                  value={connectionForm.environmentURL}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                {state.errors.environmentURL && (
                  <p className="text-red-500 text-sm absolute top-full mt-0.5 ml-1">
                    {state.errors.environmentURL}
                  </p>
                )}
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-4 items-center">
                <button
                  className={`px-8 py-3.5 rounded-md outline-none focus-visible:ring-2 ring-[#ffdf41]/50 ${connectionStatus === "on-demand" ? "bg-[#ffdf41] text-black" : "bg-gray-100 text-textLink"}`}
                  onClick={() => setConnectionStatus("online")}
                >
                  Online
                </button>
                <button
                  className={`px-8 py-3.5 rounded-md outline-none focus-visible:ring-2 ring-[#ffdf41]/50 ${connectionStatus === "scheduled" ? "bg-[#ffdf41] text-black" : "bg-gray-100 text-textLink"}`}
              ...
              <div className="p-6 flex flex-col gap-6">
                <div className="grid grid-cols-2 gap-12">
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="connectionType" className="text-sm text-textLink">
                      Connection Type
                    </Label>
                    <Input
                      id="connectionType"
                      ...
                      className="border-0"
                      value={integrationSettings.connectionType}
                  ...
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="authentication" className="text-sm text-textLink">
                      Authentication
                    </Label>
                    <Input
                      id="authentication"
                      ...
                      className="border-0"
                      value={integrationSettings.authentication}
                ...
                <div className="grid grid-cols-2 gap-12">
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="integrationCategory" className="text-sm text-textLink">
                      Integration Category
                    </Label>
                    <Input
                      ...
                      className="border-0"
                      value={integrationSettings.integrationCategory}
