...
export const checkCompanyNameValidator = z.object({
  companyName: z.string().trim().min(1, { message: "Company name is required" }),
});

export const checkCompanyCodeValidator = z.object({
  companyCode: z.string().trim().min(1, { message: "Company code is required" }),
});
