  ...
  return (
    <div className={`${false ? "pr-[336px]" : ""} relative`}>
      <div className="flex items-center justify-between">
        {/* Use table views component from the teams flow */}
        ...
        <div className="grid grid-flow-col auto-cols-max items-center">
          ...
          <Button
            ...
            size="md"
            onClick={() => navigate("/x/ui/notifications/new")}
          >
      ...
      <div className="max-w-[450px] mx-auto">
        <EmptyList
          ...
          ctaText="Click here to create your first notification."
          ctaHandle={() => navigate("/x/ui/notifications/new")}
        />
      </div>
    </div>
  );
